<template>
  <div style="position: absolute;width: 100%;height: 100%;left: 0;top: 0;background-color: #fff">
    <el-menu
      ...
      <el-menu-item @click="fd1" index="1">公司信息</el-menu-item>
      <el-menu-item @click="fd2" index="2">招聘信息</el-menu-item>
      <el-menu-item @click="fd3" index="3">面试申请</el-menu-item>
...
export default {
  ...
  methods: {
    ...
    initEditAttribute() {
      ...
      fetch(localhost + gsmc + "/company/zpsj")
          .then((res) => res.json())
          .then((data) => {
            this.table_columns2 = data['columns']
            data = data['data']
            var self = this;
            // eslint-disable-next-line no-unused-vars
            var edit = self.edit;
